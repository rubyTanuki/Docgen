...
@dataclass
class CSharpFile(BaseFile):
    pass

@dataclass
class CSharpField(BaseField):
    ACCESS_MODIFIERS = {"public", "protected", "private", "internal", "protected internal", "private protected"}

@dataclass
class CSharpClass(BaseClass):
    ACCESS_MODIFIERS = {"public", "protected", "private", "internal", "protected internal", "private protected"}
